    ...
    return (
        <div>
            <div className="manrope bg-[#C4C4C4] w-full">
                <div className="w-11/12 md:w-10/12 mx-auto py-16 md:py-32"> {/* Added padding */}
                    <div className="flex flex-col md:flex-row items-center md:items-start"> {/* Flex column on mobile, row on larger screens */}
                        <div className="text-center md:text-left mb-8 md:mb-0"> {/* Center text on mobile, left on larger screens */}
                            <div className="text-4xl md:text-6xl font-light text-white leading-tight"> {/* Adjusted text size and leading */}
                                <div>
                                    About
                                    <span className="font-bold ml-1">Us</span>
                                </div>
                                <span className="text-xl md:text-2xl mt-4 md:mt-0"> {/* Adjusted text size and margin */}
                                    Home
                                    <span className="text-[#FF9900] text-5xl md:text-7xl">.</span> {/* Adjusted text size */}
